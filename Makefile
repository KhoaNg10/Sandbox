...
#
# AUGEROFFLINEROOT := /home/dfnitz/Offline_trunk_28Sep18/install
#
...
# $Id: Makefile.in 30197 2017-03-31 22:10:06Z rulrich $
...
CPPFLAGS    := $(shell $(AUGEROFFLINECONFIG) --cppflags) -O0
CXXFLAGS    := $(shell $(AUGEROFFLINECONFIG) --cxxflags) -g -O0
LDFLAGS     := $(shell $(AUGEROFFLINECONFIG) --ldflags) -lMinuit -O0
